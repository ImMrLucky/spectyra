export { detectFeatures, registerDetector } from "./engine.js";

export { duplicationDetectors } from "./detectors/duplication.js";
export { contextBloatDetectors } from "./detectors/context-bloat.js";
